...
public class Movie {
    ...
    public Movie(String display_title, String mpaa_rating, int critics_pick, String byline,
                 String headline, String summary_short, String publication_date, String opening_date,
                 String date_updated, Link link, Multimedia multimedia) {
    ...
    public int getCritics_pick() { return critics_pick; }
    ...
    public String getOpening_date() { return opening_date; }
